/**
 * hooks/useSocket.js
 * Conecta ao Socket.io uma vez e expõe funções para assinar bots.
 */
...
export function useBot(botId, handlers) {
    ...
    useEffect(() => {
        ...
        const on = (ev, fn) => s.on(ev, (data) => {
            if (data.botId === botId) fn(data)
        })
        ...
        return () => {
            ...
            // Remove apenas os listeners deste hook (deixa outros intactos)
